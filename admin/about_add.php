<?php
    ...
    if(isset($_POST['sub'])){
        ...
        $res = insert('nnd_about',$upload_arr);
        // pre($res);
        // die;
                        ...
                        <form action="" method="post" class="cmxform" enctype="multipart/form-data">
                            <div class="panel">
                                <div class="panel-heading">
                                    <div class="panel-title">添加关于</div>
                                    ...
                                    <div class="col-md-7">
                                            ...
                                            <div class="input-group"><span class="input-group-addon">分类</span>
                                                <select name="type" id="standard-list1" class="form-control">
                                                    <?php //foreach($about as $item){ ?>
                                                        <option value="<?php //echo $item['about_id']; ?>">
                                                            <?php //echo $item['about_name']; ?> 
                                                        </option>
                                                    <?php //} ?>                                             
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="input-group"><span class="input-group-addon">Englist</span>
                                                <input type="text" name="title_en" value="" class="form-control" required/>
                                            </div>
                                        </div>
                                        <!-- <div class="form-group">
