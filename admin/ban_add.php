<?php
    ...
    if(isset($_POST['sub'])){
        ...
        $upload_arr['ban_thumb'] = $thumb;


        // $sql = "INSERT INTO `nnd_banner` (`ban_title`,`ban_content`,`ban_img`,`ban_time`,`ban_type`) VALUES ('$title','$content','$img','$time',$type)";
        ...
        if($res['code']==1){
            echo "<script>alert('添加成功！');window.location.href='ban_list.php'</script>";
            die;
        }else{
